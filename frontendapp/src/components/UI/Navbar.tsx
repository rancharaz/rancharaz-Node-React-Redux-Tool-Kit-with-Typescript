...
function ResponsiveAppBar() {
  ...
  return (
    <AppBar sx={{ backgroundImage: "linear-gradient(90deg, blue, violet)" }} position="static">
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          <Loyalty sx={{ display: { xs: 'none', md: 'flex' }, mr: 1 }} />
          <Typography
            variant="h6"
            noWrap
            component="a"
          ...
          <Loyalty sx={{ display: { xs: 'flex', md: 'none' }, mr: 1 }} />
          <Typography
            variant="h5"
            noWrap
            component="a"
